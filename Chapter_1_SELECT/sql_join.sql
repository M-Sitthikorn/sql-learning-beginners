...
-- ใช้ฐานข้อมูล SalesDB เพื่อดึงรายการคำสั่งซื้อ(orders)
--  พร้อมรายละเอียดที่เกี่ยวข้องของลูกค้า (customerts) 
--  สินค้า (products) และพนักงาน (employees) สำหรับแต่ละคำสั่งซื้อ ให้แสดงข้อมูลดังนี้
